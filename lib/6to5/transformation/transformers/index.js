module.exports = {
  ...
  "5to6.arrowFunctions": require("./5to6/arrow-functions"),
  "5to6.arrowFunctionExpressions": require("./5to6/arrow-function-expressions"),
  "5to6.properties.shorthand": require("./5to6/properties.shorthand"),
  "5to6.properties.method": require("./5to6/properties.method"),
  "5to6.classes": require('./5to6/classes'),
  "5to6.let": require("./5to6/let")
};
